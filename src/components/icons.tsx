...
/**
 * Brand, social, and UI icons as self-hosted SVGs.
 * All use `currentColor` so they inherit text color and respond to hover.
 */
...
export function WantedlyIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" {...props}>
