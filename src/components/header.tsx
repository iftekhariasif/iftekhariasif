  ...
  return (
    <header className="sticky top-0 z-40 w-full px-4 pt-4 sm:px-8 sm:pt-6">
      <div className="mx-auto flex max-w-5xl items-center justify-between">
        ...
        >
          <div className="flex size-9 items-center justify-center rounded-xl bg-foreground text-background font-mono text-xs font-bold tracking-tighter shadow-sm transition-transform duration-200 group-hover:scale-105">
            IA
          </div>
